...
interface AdminRegistrationHeaderProps {
  onBack: () => void;
}

// Red chrome header for the registration-mode screen with a back button to the admin hub and a
// title block.
export const AdminRegistrationHeader: FC<AdminRegistrationHeaderProps> = ({ onBack }) => {
  return (
    <RedChromeSurface
      start={
        <ButtonBase
