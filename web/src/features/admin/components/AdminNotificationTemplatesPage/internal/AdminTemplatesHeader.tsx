...
// Red chrome header for the notification-text screen with a back button to the admin hub and a
// title block.
export const AdminTemplatesHeader: FC<AdminTemplatesHeaderProps> = ({ onBack }) => {
  return (
    <RedChromeSurface
      start={
        <ButtonBase
