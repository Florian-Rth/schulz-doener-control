...
// Confirm dialog for the destructive delete action. The body explains the
// soft-retire-vs-delete behaviour. The destructive action is the primary CTA.
export const MenuConfirmDialog: FC<MenuConfirmDialogProps> = ({
  open,
  title,
  body,
  confirmLabel,
