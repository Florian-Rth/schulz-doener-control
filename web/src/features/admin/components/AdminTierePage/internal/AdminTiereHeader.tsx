...
interface AdminTiereHeaderProps {
  onBack: () => void;
}

// Red chrome header for the read-only Döner-Tiere screen with a back button to
// the admin hub and a title block.
export const AdminTiereHeader: FC<AdminTiereHeaderProps> = ({ onBack }) => {
  return (
    <RedChromeSurface
      start={
        <ButtonBase
