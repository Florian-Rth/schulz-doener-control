...
export const authCopy = {
  ...
  registerWorkEmailLabel: "Arbeits-E-Mail (optional)",
  registerWorkEmailPlaceholder: "z. B. max@schulz.st",
  registerWorkEmailInvalid: "Bitte gib eine gültige E-Mail-Adresse ein, Chef.",
  registerWorkEmailLength: "Höchstens 256 Zeichen.",
